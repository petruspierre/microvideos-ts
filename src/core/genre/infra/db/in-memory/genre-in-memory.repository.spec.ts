...
describe('GenreInMemoryRepository', () => {
  ...
  it('should no filter items when filter object is null', async () => {
    const items = [Genre.fake().one().build(), Genre.fake().one().build()];
  ...
  it('should sort by created_at when sort param is null', async () => {
    const items = [
      Genre.fake().one().withCreatedAt(new Date()).build(),
      Genre.fake()
        .one()
  ...
  it('should sort by name', async () => {
    const items = [
      Genre.fake().one().withName('c').build(),
      Genre.fake().one().withName('b').build(),
      Genre.fake().one().withName('a').build(),
    ];
